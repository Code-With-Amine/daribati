...
// Local lightweight Field components to avoid depending on a missing module.
// These mimic the structure expected by the page and use the existing `cn` helper.
          ...
          <Card className="overflow-hidden p-0">
            <CardContent className="grid p-0 md:grid-cols-2">
              <form className="p-6 md:p-8" onSubmit={submit}>
                <FieldGroup>
                  <div className="flex flex-col items-center gap-2 text-center">
                    <h1 className="text-2xl font-bold">Bienvenu</h1>
                  ...
                  <Field>
                    <Button
                      type="submit"
                      className="bg-[#262EE3] hover:bg-[#150AA3] text-white"
                      disabled={loading}
                    >
              ...
              <div className="relative hidden bg-muted md:block">
                <img
                  src="https://imgs.search.brave.com/ahzonJQpN2xru84dPkkLnT0h5YKQrn_lN1k1rI3YJYI/rs:fit:860:0:0:0/g:"
                  alt="Image"
